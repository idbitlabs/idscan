        ...
        <div class="container-xxl">
          <div class="d-flex flex-wrap justify-content-between align-items-center gap-4">
            <div>
              ...
              <h1 class="h5 text-white my-1">Advanced Filter</h1>
            </div>
          ...
          <div class="col-lg-8 col-xl-9">
            <div class="card mb-4" id="spanResult">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-header-title">Advanced Filter</h3>
                <a
              ...
              <div class="card-body">
                <p>View all your saved filters.</p>
                        ...
                        <div class="input-group" style={{ minWidth: "22rem" }}>
                          ...
                          >
                            ...
                            <button
                              ...
                              title="Search Title or Description"
                            >
                              Find
                            </button>
                          </form>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>
                Are you sure you wish to remove this filter?
                <br />
                <span style={{ display: " none" }} id="removefilter"></span>
              </p>
            </div>
            <div class="modal-footer bg-light">
              ...
              <button
                ...
                onclick="javascript:removesavefilter();"
              >
                Remove
              </button>
            </div>
...
export default Myadvancedfilters;
