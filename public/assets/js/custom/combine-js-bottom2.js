        ...
        $('.searchautocomplete').autocomplete({
            ...
            if (item.label == "ShowAds" && item.desc == "" && item.typeval == "" && item.checkMark == "" && item.logo == "") {
                ...
                if (contentType === "Private") {
                    ...
                    return $("<li class='mb-2'>").append("<a class='ether-search media rounded p-2' href='javascript:;'><div class='me-2'>" + imglogo + "</div><div class='media-body text-truncate'><h6 class='d-flex align-items-center text-size-1 mb-0'><div class='text-truncate me-2'>" + item.label + "</div>" + price + tickMark + "</h6><span class='text-secondary text-truncate fs-sm'>" + item.value + "</span>" + website + "</div></a>").appendTo(ul);
                } else if (contentType === "Addresses") {
                    var addressContent = item.label.substring(0, 42);
                    return $("<li class='mb-2'>").append("<a class='ether-search media rounded p-2' href='javascript:;'><div class='me-2'>" + imglogo + "</div><div class='media-body text-truncate'><h6 class='text-size-1 mb-0 text-truncate'>" + addressContent + "</h6></div></a>").appendTo(ul);
                } else if (contentType === "Labels") {
                    return $("<li class='mb-2'>").append("<a class='ether-search media rounded p-2' href='javascript:;'><div class='me-2'><span class='btn btn-icon btn-soft-secondary rounded-circle'><i class='fa fa-tag btn-icon__inner'></i></span></div ><div class='media-body text-truncate'><h6 class='text-size-1 mb-0'>" + item.label.substring(0, 42) + "</h6></div></a>").appendTo(ul);
                }
            }
        };
    }
